 ...
 * @property {HTMLButtonElement} prev The button to jump to the previous slide
 * @property {HTMLButtonElement} next The button to jump to the next slide
 * @property {HTMLButtonElement} last The button to jump to the last slide
...
export class Controls extends HTMLElement {
  ...
  /**
   * Called when the element is inserted into the DOM. Used to fetch the template an wire into the related navigator instance
   */

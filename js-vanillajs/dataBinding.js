...
export class DataBinding {
   ...
   * @param {object} value Any value to observable
   * @return {Observable} The observable instance to use
   */
  observable(value) {
  ...
  bindObservables(elem, context) {
    ...
    dataBinding.forEach(elem => {
      this.bindValue(/** @type {HTMLInputElement} */ (elem), context[elem.getAttribute('data-bind')])
    })
  }

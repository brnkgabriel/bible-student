...
export class Materials {
  ...
  /**
   * returns a list of object from a list of strings
   * @param {string[]} skus
   * @returns {object[]} 
   */
  expand(skus) {
  ...
  /**
   * returns an object from a list of keyValue string list
   * @param {string[]} skuDetails
   * @returns {object}  
   */
  json(skuDetails) {
    var obj = {}
   ...
   * @returns {object[]}
   */
  get data() { return this.expand(this._data) }
}